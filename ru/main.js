String.prototype.format = function () {
  ...
  let text = [
    ...
    "Привет, я <u class='consoleLinkMorkovka21Vek'>Morkovka21Vek</u>",
    'print(Morkovka21Vek.data)',
];

new_result = '???> python<br>Python 3.11.1 (tags/v3.11.1:a7a450f, Dec  6 2022, 19:58:39) [MSC v.1934 64 bit (AMD64)] on win32<br>Type "help", "copyright", "credits" or "license" for more information.<br>>>>from users import Morkovka21Vek<br>print(Morkovka21Vek.hello)<br>'+"Привет, я <u class='consoleLinkMorkovka21Vek'>Morkovka21Vek</u><br>"+'print(Morkovka21Vek.data)<br>{<br>"Платформа": "Windows 10"<br>"Страна": "Россия/Москва"<br>"время": "UTC +03:00"<br>}<br>';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    lastCommitsH.forEach(myH => {
        ...
        xhr.onload = function() {
            if (xhr.status == 200) {
                ...
                var LastCommitDateOut = "Последнее изменение: "+rightCommitDate;
    ...
    function typeLine() {
        ...
        if (line == 6) {
            setTimeout(() => {
                result += '{<br>"Платформа": "Windows 10"<br>"Страна": "Россия/Москва"<br>"Время": "UTC +03:00"<br>}'
                document.querySelectorAll('.consoleTextP').forEach(consolePtext => {
                    consolePtext.innerHTML = result;// + '|';
                    // consolePtext.scrollTop = consolePtext.scrollHeight;
                })
