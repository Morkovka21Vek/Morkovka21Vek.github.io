document.addEventListener('DOMContentLoaded', function() {
    ...
    xhr.open("GET", "https://gist.githubusercontent.com/Morkovka21Vek/e08485da0c9de11892ec5b9e2a7016bf/raw/2fffde5b7402950e08c882e3c1e0e2565dfd7132/testForSchoolBreadShop.json");
    xhr.send();
    xhr.onload = function() {
        if (xhr.status == 200) {
            ...
            json.categories.forEach(category => {
                ...
                category.products.forEach(product => {
                    ...
                    if (product.yellowText !== "") product.yellowText = '<br><p class="yellowText">' + product.yellowText + "</p>";
                    if (product.redText !== "") product.redText = '<br><p class="redText">' + product.redText + "</p>";
